...
<p> This is after, we have integrated Jenkins with Ansible which pushes a Docker Image into the Dockerhub through playbook1 and then makes DockerHost-server pull that image from the DockerHub and build the image to run a container. It exposes port 8082. </p>
